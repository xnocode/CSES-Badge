...
export default function Home() {
  ...
  const [color, setColor] = useState('#2ea44f');
  ...
  useEffect(() => {
    ...
    if (finalColor && finalColor !== '2ea44f') {
  ...
  }, [userId, theme, style, color, customColor, label, logo, viewType]);
  ...
  const markdownCode = `[![CSES Profile](${badgeUrl})](https://cses.fi/user/${userId})`;
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-50 flex flex-col items-center justify-between p-6 sm:p-24 selection:bg-emerald-500 selection:text-white">
      ...
      <div className="w-full max-w-5xl flex flex-col gap-12 z-10">
        ...
        <div className="text-center sm:text-left flex flex-col gap-3">
          ...
          <p className="text-lg text-zinc-400 max-w-2xl">
            Generate stunning SVG badges and stats cards for your competitive programming profile.
            Fully customizable with 10 themes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 p-6 sm:p-8 rounded-3xl">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                placeholder="e.g. 3"
                className="px-4 py-2.5 bg-zinc-950 border border-zinc-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-white font-medium"
              />
              <span className="text-[11px] text-zinc-500">
                Your numerical User ID from cses.fi/user/ID
              </span>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex items-center gap-3">
                <div className="flex gap-2">
                  {['#2ea44f', '#2563eb', '#f97316', '#f43f5e', '#a855f7'].map((c) => (
                    <button
                      key={c}
                      onClick={() => {
                        setColor(c);
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 bg-zinc-950 border border-zinc-800 rounded-xl focus:outline-none focus:ring-1 focus:ring-emerald-500 text-xs text-white uppercase font-mono"
                />
              </div>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 w-full">
            {/* Live Preview */}
            <div className="flex flex-col gap-4 bg-zinc-900/30 border border-zinc-800/80 p-8 rounded-3xl items-center justify-center min-h-[250px]">
              <span className="text-xs font-semibold uppercase tracking-wider text-zinc-500 self-start mb-2">
                Live Preview
              </span>
              {badgeUrl && (
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    readOnly
                    value={badgeUrl}
                    className="w-full px-4 py-2 bg-zinc-950 border border-zinc-800 rounded-xl text-zinc-300 font-mono text-xs select-all focus:outline-none"
                  />
                  <button
